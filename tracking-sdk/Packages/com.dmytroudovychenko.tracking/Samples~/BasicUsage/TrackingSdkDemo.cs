...
namespace DmytroUdovychenko.Tracking.Samples
{
    /// <summary>
    /// Importable package sample. Auto-spawns on Play and builds a Canvas UI for live SDK testing.
    /// </summary>
    public sealed class TrackingSdkDemo : MonoBehaviour
    {
        ...
        {
            if (FindAnyObjectByType<TrackingSdkDemo>() != null)
            {
                return;
            }

            GameObject rootObject = new GameObject(DEMO_ROOT_NAME);
            rootObject.AddComponent<TrackingSdkDemo>();
        }
        ...
        {
            Tracker.Dispose();
            Tracker.Init(DEMO_USER_ID, ServerEnvironment.FakeServerChaos);
        ...
        {
            Tracker.Dispose();
            Tracker.Init(DEMO_USER_ID, ServerEnvironment.HttpTestServerChaos);
        ...
        {
            Tracker.Dispose();
            Tracker.Init(DEMO_USER_ID, ServerEnvironment.HttpTestServer);

...
2. Draw the **how-to-verify** from what the change actually affects: the headless EditMode run, plus any specific behaviour a human can confirm via the demo (`Assets/TrackingDemo`, auto-spawns on Play) or the `[Explicit]` live tests.
